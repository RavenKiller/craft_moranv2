...
if __name__ == '__main__':
    ...
    k = 0
    # print("Test image {:d}/{:d}: {:s}".format(k+1, 1, image_path), end='\r')
    image = imgproc.loadImage(image_path)

    bboxes, polys, score_text,rot_rects = test_net(net, image, args.text_threshold, args.link_threshold, args.low_text, args.cuda, args.poly, refine_net)

    # save text rectangles
    file_utils.saveSplitTextRects(image,rot_rects,bboxes,save_prefix="rect_1")
    ...
    # file_utils.saveResult(image_path, image[:,:,::-1], polys, dirname=result_folder,texts=[1,2,3,4,5,6,7,8,9,0])
