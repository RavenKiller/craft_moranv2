...
if __name__ == '__main__':
    ...
    ################################################
    for v in os.listdir(tmp_folder):
        img_path = os.path.join(tmp_folder,v)
        if not ('.jpg' in img_path or '.png' in img_path):
            continue
    ...
    file_utils.saveResult(args.img_path, image_raw[:,:,::-1], polys, texts=all_text,dirname=tmp_folder)
    print(all_text)
    print(all_text_reverse)